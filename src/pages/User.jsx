        ...
        <div className='w-full py-5 mb-6 rounded-lg shadow-md bg-base-300 stats'>
          <div className='grid grid-cols-1 md:grid-cols-3'>
            ...
            <div className='stat place-items-center'>
              <FaUsers className='text-3xl md:text-5xl mr-4 mb-3'/>
            ...
            <div className='stat place-items-center'>
              <FaUserFriends className='text-3xl md:text-5xl mr-4 mb-3'/>
            ...
            <div className='stat place-items-center'>
              <FaCodepen className='text-3xl md:text-5xl mr-4 mb-3'/>
